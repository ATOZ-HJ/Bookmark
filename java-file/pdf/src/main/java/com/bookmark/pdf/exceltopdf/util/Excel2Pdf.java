package com.bookmark.pdf.exceltopdf.util;
...
//        pageSize =new RectangleReadOnly(1000.0F, 850.0F);
        // 單張
        if (this.objects.size() <= 1) {
            // 使用 Excel 版面設定中的紙張大小作為 PDF 輸出紙張大小
            // pageSize = this.objects.get(0).getPageSize();
   //todo 字体大小！！
          //  todo pageSize =new RectangleReadOnly(1300.0F, 700.0F);
           // pageSize = PageSize.A0.rotate();
