...
public class JZ7 {
    ...
    /**
     * 运行时间：12ms 超过79.52% 用Java提交的代码 占用内存：9720KB 超过5.00%用Java提交的代码
     * <p>
     * 代码不够简洁
     *
     * @param n
    ...
    /**
     * 官方解答1:使用递归实现，时间复杂度较高 运行时间：323ms 超过33.92% 用Java提交的代码 占用内存：9764KB 超过3.38%用Java提交的代码
     * <p>
     * <p>
     * 简单递归 性能较差
     *
    ...
    /**
     * <p>
     * 使用动态规划的方式 状态转移方程 : F(n) = F(n-1) + f(n+1) 边界 : f(0) = 0 ; f(1) = 1 最优子结构 ： F(n-1) + f(n+1)
     * <p>
     * <p>
     * 运行时间：12ms 超过79.52% 用Java提交的代码 占用内存：9720KB 超过5.06%用Java提交的代码
     *
     * @param n
     * @return
     */
