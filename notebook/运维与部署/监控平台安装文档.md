...
```
docker run -d --name promtail --privileged=true -v $(pwd):/mnt/config -v /home/ksquant/qtserver/bond/logs/bond.log:/logs grafana/promtail:2.3.0 -config.file=/mnt/config/promtail-config.yaml
```
